...
public class TextAdventureFix {
    public static void main(String[] args) {
        ...
        if (stringOperand1.equals("poison blowdart")) {
            ...
            System.exit(0);
        } else if (stringOperand1.equals("master sword")) {
            System.out.println("That only exists in video games nerd! GAME OVER");
            System.exit(0);
        } else if (stringOperand1.equals("straight sword")) {
        ...
        if (stringOperand1.equals("heal")) {
            ...
            System.exit(0);
        } else if (stringOperand1.equals("ignore")) {
            ...
            System.exit(0);
        } else if (stringOperand1.equals("slay")) {
